...
for iProfile=1:length(profiles)
    ...
    for iGrid = 1:2
        ...
        for iMethod=1:length(methods)
            ...
            k = 0.1*k_star;
            [F,G,h,~,F2,N2G2,G2,uMaxRatio,wMaxRatio,kConstantRatio] = im.modesAtWavenumber( k, 'F2', 'N2G2', 'G2', 'uMax', 'wMax', 'kConstant' );
            [F_analytical,G_analytical,h_analytical,~,F2_analytical,N2G2_analytical,G2_analytical,uMaxRatio_analytical,wMaxRatio_analytical,kConstantRatio_analytical] = imAnalytical.modesAtWavenumber( k, 'F2', 'N2G2', 'G2', 'uMax', 'wMax', 'kConstant' );
            ...
            max_error_ratio= max([errorFunction(uMaxRatio_analytical,uMaxRatio); errorFunction(wMaxRatio_analytical,wMaxRatio); errorFunction(kConstantRatio_analytical,kConstantRatio)],[],1);
