...
+ Build discrete transforms
  ...
  + [`fitQuadrature`](/internal-modes/classes-v2/core/imbasisset/fitquadrature.html) Fit quadrature increments on fixed physical sample points.
  + [`quadraturePoints`](/internal-modes/classes-v2/core/imbasisset/quadraturepoints.html) Return a full-depth grid generated by the next selected mode.
+ Inspect basis sets
