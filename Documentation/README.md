...
+ The `../tools/build_website_documentation.m` script rebuilds the published `../docs` folder by copying the website source, generating the version-history page from `../CHANGELOG.md`, and extracting class reference pages with `class-docs`.
