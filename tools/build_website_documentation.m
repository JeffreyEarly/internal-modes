...
writeClassGroups(classGroups, websiteRootURL, buildFolder);

classV2FolderName = "Class documentation V2";
classV2Groups = {
    struct( ...
        "parent", "Core", ...
        "grandparent", classV2FolderName, ...
        "methodGrandparent", "Core", ...
        "websiteFolder", "classes-v2/core", ...
        "classes", {{"IMEigenvalueProblem", "IMBoundaryCondition", "IMBasisSet", ...
        "IMHydrostaticBoundaryCondition", "IMInternalModes", "IMInternalModesBasis", ...
        "IMMeanDensityAnomalyModes", "IMMeanDensityAnomalyModesBasis", ...
        "IMGeostrophicZeroAPVModes", "IMGeostrophicZeroAPVModesBasis"}} ...
    )
    struct( ...
        "parent", "Solvers", ...
        "grandparent", classV2FolderName, ...
        "methodGrandparent", "Solvers", ...
        "websiteFolder", "classes-v2/solvers", ...
        "classes", {{"IMSolver", "IMSolverSpectral", "IMSolverFiniteDifference"}} ...
    )
    struct( ...
        "parent", "Analytical bases", ...
        "grandparent", classV2FolderName, ...
        "methodGrandparent", "Analytical bases", ...
        "websiteFolder", "classes-v2/analytical-bases", ...
        "classes", {{"IMAnalyticalSolution", "IMConstantStratificationSolution", "IMExponentialStratificationSolution", "IMAnalyticalInternalModesBasis", "IMAnalyticalGeostrophicZeroAPVModesBasis"}} ...
    )
    struct( ...
        "parent", "Discrete transforms", ...
        "grandparent", classV2FolderName, ...
        "methodGrandparent", "Discrete transforms", ...
        "websiteFolder", "classes-v2/discrete-transforms", ...
        "classes", {{"IMBasisCollection", "IMProjectionRecipe", "IMProjection", "IMBasisAssessment", "IMProductInventory", "IMProductPlan", "IMProductAssessment", ...
            "IMDiscreteTransform", "IMDiscreteTransformAssessment", "IMQuadratureWeightFit", ...
            "IMInternalModesDiscreteTransform", "IMInternalModesDiscreteTransformAssessment", "IMInternalModesQuadratureWeightFit", ...
            "IMGeostrophicTransform"}} ...
    )
    struct( ...
        "parent", "Supporting types", ...
        "grandparent", classV2FolderName, ...
        "methodGrandparent", "Supporting types", ...
        "websiteFolder", "classes-v2/supporting-types", ...
        "classes", {{"Normalization"}} ...
    )
};

writeClassGroups(classV2Groups, websiteRootURL, buildFolder);

trimTrailingWhitespaceInMarkdown(buildFolder)
end

function writeClassGroups(classGroups, websiteRootURL, buildFolder)
for iGroup = 1:numel(classGroups)
    group = classGroups{iGroup};
    methodGrandparent = "Classes";
    if isfield(group, "methodGrandparent")
        methodGrandparent = group.methodGrandparent;
    end
