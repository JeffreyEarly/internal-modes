...
classV2Groups = {
    struct( ...
        ...
        "classes", {{"IMEigenvalueProblem", "IMBasisSet", "IMOperator", "IMBoundary", "IMBoundaryWeight", "IMIndexPolicy"}} ...
    )
    struct( ...
        "parent", "Solvers", ...
        "grandparent", classV2FolderName, ...
        ...
        "classes", {{"IMSolver", "IMSolverSpectral", "IMSolverWKBSpectral", ...
        "IMSolverDensitySpectral", "IMSolverFiniteDifference"}} ...
    )
    struct( ...
        ...
        "classes", {{"IMBasisSetConstantStratification", "IMBasisSetExponentialStratification"}} ...
    )
    struct( ...
        "parent", "Supporting types", ...
        "grandparent", classV2FolderName, ...
...
switch string(className)
    ...
    case {"IMSolverWKBSpectral", "IMSolverDensitySpectral"}
        excludedSuperclasses = {"IMSolver", "IMSolverSpectral"};
